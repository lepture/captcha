...
class ImageCaptcha:
    ...
    def generate_image(self, chars: str, bg_color: ColorTuple | None = None, fg_color: ColorTuple | None = None) -> Image:
        ...
        color = fg_color if fg_color else random_color(10, 200, random.randint(220, 255))
    ...
    def generate(self, chars: str, format: str = 'png', bg_color: ColorTuple | None = None, fg_color: ColorTuple | None = None) -> BytesIO:
    ...
    def write(self, chars: str, output: str, format: str = 'png', bg_color: ColorTuple | None = None, fg_color: ColorTuple | None = None) -> None:
